...
/**
 * Extracts whether the Grammar Name of the classification unit exists or not.
 */
public class GrammarNameTokenOccurrence
    extends FeatureExtractorResource_ImplBase
    implements FeatureExtractor
{
    /**
     * Public name of the feature "GrammarName"
     */
    public String FEATURE_NAME = "GrammarName";
